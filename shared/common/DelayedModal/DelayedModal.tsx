...
export const DelayedModal = ({ isOpen, onClose }: DelayedModalProps) => {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="!max-w-7xl w-[95vw] overflow-y-auto lg:p-4 p-0 pt-6 border">
        <div className="grid grid-cols-1 lg:grid-cols-12 p-2 gap-4 lg:gap-8 items-center">
          {/* Left Panel - Promotional Content */}
          <div className="rounded-3xl p-2 lg:p-8 flex-1 relative overflow-hidden col-span-1 lg:col-span-5 lg:h-[70vh]">
            {/* Background Pattern */}
            <Image
              src={"/assets/hold-on-back.webp"}
              alt="hold-on-back"
              className="object-cover lg:block hidden absolute top-0 left-0 h-full w-full"
              width={500}
              height={500}
            />
          ...
          <div className="col-span-1 lg:col-span-7 px-2 py-4">
            <ModalForm />
          </div>
        </div>
      </DialogContent>
